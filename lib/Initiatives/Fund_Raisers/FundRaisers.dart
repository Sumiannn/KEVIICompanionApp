      ...
      body: Stack(clipBehavior: Clip.none, children: [
        ...
        Positioned(
          ...
          child: Container(
            ...
            width: MediaQuery.of(context).size.width,
            child: Text(
              "Check out fund raisers organised by your fellow hall mates and do support them!",
              style: TextStyle(
                  fontFamily: 'Montserrat',
                  fontSize: 18,
          ...
          child: Container(
              ...
              child: StreamBuilder(
                  stream: FirebaseFirestore.instance
                      .collection('Fund Raisers')
                      .orderBy('Deadline Timestamp')
                      .snapshots(),
                  builder: (context, snapshot) {
                    if (!snapshot.hasData || snapshot.data.docs.length == 0) {
                      return Center(
                        child: Text(
                          'Currently, there are no ongoing fund raisers! Watch this space for updates!',
                          style: TextStyle(
                            fontSize: 20,
                      ...
                      tabBarViews.add(
                        ListView(
                          children: [
                            ...
                            doc['External Link'] != 'None'
                                ? Container(
                              margin: EdgeInsets.only(
                                  left: 20, right: 20, top: 10),
                              child: ElevatedButton(
                                onPressed: () {
                                  _launchURL(doc['External Link']);
                                },
                                style: ButtonStyle(
                                    backgroundColor:
                                ...
                                : SizedBox(),
                            doc['Payment Link'] != 'None'
                                ? Container(
                              margin: EdgeInsets.only(
                                  left: 20, right: 20, top: 10),
                              child: ElevatedButton(
                                onPressed: () {
                                  _launchURL(doc['Payment Link']);
                                },
                                style: ButtonStyle(
                                    backgroundColor:
                                    MaterialStateProperty.all<Color>(
