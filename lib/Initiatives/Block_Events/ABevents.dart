...
class ABevents extends StatelessWidget {
  @override
      ...
      body: Stack(clipBehavior: Clip.none, children: [
        ...
        Positioned(
          ...
          child: Container(
            ...
            width: MediaQuery.of(context).size.width,
            child: Text(
              "Hello AB Blockers! Look at what your Block Committee has in store for you guys!",
              style: TextStyle(
                  fontFamily: 'Montserrat',
                  fontSize: 18,
          ...
          child: Container(
              ...
              child: StreamBuilder(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('Block', isEqualTo: 'AB').orderBy('Timestamp')
                      .snapshots(),
