...
class CDevents extends StatelessWidget {
  @override
          ...
          children: [
            ...
            Positioned(
              ...
              child: Container(
                ...
                width: MediaQuery.of(context).size.width,
                child: Text(
                  "Welcome CD Blockers! Look at what your Block Committee has in store for you guys!",
                  style: TextStyle(
                      fontFamily: 'Montserrat',
                      fontSize: 18,
              ...
              child: Container(
                  child: StreamBuilder(
                      stream: FirebaseFirestore.instance
                          ...
                          .where('Block', isEqualTo: 'CD').orderBy('Timestamp')
                          .snapshots(),
                        ...
                        if (!snapshot.hasData ||
                          ...
                          return Center(
                            child: Text(
                              ...
                              style:TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: CDColor,),
