...
class CommitteeCCA extends StatefulWidget {
  CommitteeCCA();
  @override
  _CommitteeCCAState createState() => _CommitteeCCAState();
}

class _CommitteeCCAState extends State<CommitteeCCA> {
  @override
          ...
          Stack(
            ...
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  height: MediaQuery.of(context).size.height * 0.4,
                    child: Image.asset('assets/image/CommPhoto.jpeg', fit: BoxFit.fitHeight,)),
              ),
              Positioned(
                top: 25,
                left: 15,
              ...
              Positioned.fill(
                ...
                child: Container(
                    child: StreamBuilder(
                      stream: FirebaseFirestore.instance.collection('CCA Information').where('Type', isEqualTo: 'Committee').snapshots(),
